...
- Follow-up product decision (2026-08-11): keep guest and hotel data securely separated while making both experiences discoverable from one Intellistay product. Welcome offers only reservation or guest access plus one top-right Hotel team entry; do not add a separate demo shortcut or duplicate staff block. Hotel team opens the protected connected mobile operations experience, and every guest/staff flow must expose a clear return to the welcome sign-in. Keep the responsive desktop operations website for laptop use. Use the home/stay symbol for the Intellistay brand mark and reserve lightning only for AI activity and credits.
