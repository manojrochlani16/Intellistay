...
- Follow-up product decision (2026-08-11): keep guest and hotel data securely separated while making both experiences discoverable from one Intellistay product. Welcome must offer a no-login demo path and a Hotel Operations switch; guest Profile and the staff sidebar must provide reciprocal experience-switch controls that always pass through the staff access gate. Use the home/stay symbol for the Intellistay brand mark and reserve lightning only for AI activity and credits.
